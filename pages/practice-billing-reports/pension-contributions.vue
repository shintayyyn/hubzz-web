...
export default {
    ...
    itemCountInfo() {
      ...
      const lastItem = Math.min(
        this.limit * this.activePage -
          this.limit +
          (this.loading ? this.limit : this.locumInvoiceReports.length),
        this.count
      );
    ...
    columnDetails() {
      return [
        ...
        },
        {
          ...
          column: item =>
            item.paid_at
              ? this.$moment(item.paid_at, "YYYY-MM-DD").format("DD/MM/YYYY")
              : "N/A",
          justify: "left",
          flexGrow: 1,
          flexShrink: 0
  ...
  mounted() {
    ...
    this.invoiceNumberIncludes = invoiceNumberIncludes
      ? invoiceNumberIncludes
      : "";
    ...
    this.professionNameIncludes = professionNameIncludes
      ? professionNameIncludes
      : "";
    this.jobPartNumberIncludes = jobPartNumberIncludes
      ? jobPartNumberIncludes
      : "";
  ...
  methods: {
    ...
    filterSearch() {
      ...
      const query = {
        ...
        invoice_number_includes: this.invoiceNumberIncludes
          ? this.invoiceNumberIncludes
          : undefined,
        locum_name_includes: this.locumNameIncudes
          ? this.locumNameIncudes
          : undefined,
        ...
        job_part_number_includes: this.jobPartNumberIncludes
          ? this.jobPartNumberIncludes
          : undefined,
        min_pension_amount: this.minPensionAmount
          ? this.minPensionAmount
          : undefined,
        max_pension_amount: this.maxPensionAmount
          ? this.maxPensionAmount
          : undefined,
        calendar_date_start: this.calendarDateStart
          ? this.calendarDateStart
          : undefined,
        calendar_date_end: this.calendarDateEnd
          ? this.calendarDateEnd
          : undefined,
    ...
    getLocumInvoiceReportPensionContributions() {
      ...
      Promise.all([
        this.$axios
          .get("/api/v1/admin/reports/pension-contributions/count", {
            cache: true,
            params: {
              ...params
            }
        ...
        this.$axios
          .get("/api/v1/admin/reports/pension-contributions", {
            cache: true,
            params: {
              ...params,
              order_by: this.orderBy,
        ...
        .then(results => {
          const [count, locumInvoiceReports] = results;
    ...
    downloadCsv() {
      ...
      this.$axios
        .post(
          "/api/v1/admin/reports/pension-contributions/generate-key",
          {
        ...
        .then(responses => {
          ...
          window.open(
            `${process.env.API_URL}/api/v1/admin/reports/pension-contributions/csv?token=${token}`
          );
        })
        .catch(err => {
          console.log("err", err);
