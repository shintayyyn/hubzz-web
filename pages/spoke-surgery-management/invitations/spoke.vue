<template>
  <div class="p-4">
    <template v-if="!hasParentPractice">
      <div
        v-if="practiceHub"
        class="flex flex-col md:flex-row w-full pb-2 md:pb-0"
      >
        <div class="md:w-1/2">
          ...
          <div class="flex flex-col mx-2">
            ...
            <div class="flex flex-col mt-4 md:flex-row w-full leading-tight">
              ...
              <div class="md:w-2/3">
                <div class="md:mx-0">
                  {{
                    practiceHub && practiceHub.address_line_1
                ...
                <div class="md:mx-0">
                  {{
                    practiceHub && practiceHub.address_line_2
                ...
                <div class="md:mx-0">
                  {{
                    practiceHub && practiceHub.address_line_3
                ...
                <div class="md:mx-0">
                  {{
                    practiceHub && practiceHub.address_line_4
                ...
                <div class="md:mx-0">
                  {{
                    practiceHub && practiceHub.address_line_5
                      ? practiceHub.address_line_5
                      : null
                  }}
                </div>
              </div>
      ...
      <div v-else class="py-4 text-center text-gray-500">
        You have no pending Hub invitations.
      </div>
    </template>
    ...
    <transition name="fade" mode="out-in">
      <nuxt-link
        v-if="
          ['spoke-surgery-management-invitations-spoke-create'].includes(
            $route.name
          )
        "
