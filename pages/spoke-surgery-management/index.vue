        ...
        <div class="md:w-1/2">
          ...
          <div class="flex flex-col mx-2">
            <div class="flex flex-col mt-4 md:flex-row w-full leading-tight">
              <p class="md:w-1/3 font-semibold">
                Practice Name
              </p>
              <p class="md:w-2/3 mx-2 md:mx-0">
                {{ practiceHub.surgery.name }}
              </p>
            </div>
            <div class="flex flex-col mt-4 md:flex-row w-full leading-tight">
              <p class="md:w-1/3 font-semibold">
            ...
            <div class="flex flex-col mt-4 md:flex-row w-full leading-tight">
              ...
              <p class="md:w-2/3 mx-2 md:mx-0">
                {{ practiceHub.clinical_commissioning_group_name }}
              </p>
            </div>
            <div class="flex flex-col mt-4 md:flex-row w-full leading-tight">
              <p class="md:w-1/3 font-semibold">
            ...
            <div class="flex flex-col mt-4 md:flex-row w-full leading-tight">
              <div class="md:w-1/3 font-semibold">
                Address
              </div>
              <div class="md:w-2/3">
                <div
                  class="md:mx-0"
                >
                  {{ practiceHub && practiceHub.address_line_1 ? practiceHub.address_line_1: null }}
                </div>
                <div
                  class="md:mx-0"
                >
                  {{ practiceHub && practiceHub.address_line_2 ? practiceHub.address_line_2: null }}
                </div>
                <div
                  class="md:mx-0"
                >
                  {{ practiceHub && practiceHub.address_line_3 ? practiceHub.address_line_3: null }}
                </div>
                <div
                  class="md:mx-0"
                >
                  {{ practiceHub && practiceHub.address_line_4 ? practiceHub.address_line_4: null }}
                </div>
                <div
                  class="md:mx-0"
                >
                  {{ practiceHub && practiceHub.address_line_5 ? practiceHub.address_line_5: null }}
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row w-full mt-2 leading-tight">
              ...
              >
                {{ practiceHub.report_to ? practiceHub.report_to : 'N/A' }}
              </p>
            </div>
            <div class="flex flex-col md:flex-row w-full mt-2 leading-tight">
              <p class="md:w-1/3 font-semibold">
              ...
              <p class="md:w-2/3 mx-2 md:mx-0">
                {{ practiceHub.email ? practiceHub.email : 'N/A' }}
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="mx-2">
            ...
            >
              ...
              <div class="flex flex-col md:flex-row">
                <p class="text-sm font-semibold md:w-2/3">
                  Maximum Hourly Rate Limit
                </p>
                <p
                  class="text-sm text-sm mx-2 md:mx-0"
                >
                  {{ practiceSpoke.max_hourly_rate_limit ?'£ '+ practiceSpoke.max_hourly_rate_limit : 'N/A' }}
                </p>
              </div>
              <div class="flex flex-col md:flex-row">
                <p class="text-sm font-semibold md:w-2/3">
                ...
                <p
                  class="text-sm text-sm mx-2 md:mx-0"
                >
                  {{ practiceSpoke.max_halfday_rate_limit ?'£ '+ practiceSpoke.max_halfday_rate_limit : 'N/A' }}
                </p>
              </div>
              <div class="flex flex-col md:flex-row">
                <p class="text-sm font-semibold md:w-2/3">
                ...
                <p
                  class="text-sm text-sm mx-2 md:mx-0"
                >
                  {{ practiceSpoke.max_wholeday_rate_limit ?'£ '+ practiceSpoke.max_wholeday_rate_limit : 'N/A' }}
                </p>
              </div>
              <div class="flex flex-col md:flex-row">
                <p class="text-sm font-semibold md:w-2/3">
                ...
                <p
                  class="text-sm text-sm mx-2 md:mx-0"
                >
                  {{ practiceSpoke.max_ooh_rate_limit ?'£ '+ practiceSpoke.max_ooh_rate_limit : 'N/A' }}
                </p>
              </div>
              <div class="flex flex-col md:flex-row">
                <p class="text-sm font-semibold md:w-2/3">
                ...
                <p
                  class="text-sm text-sm mx-2 md:mx-0"
                >
                  {{ practiceSpoke.max_excess_hours ? practiceSpoke.max_excess_hours +' Hours' : 'N/A' }}
                </p>
              </div>
            </div>
            <div class="flex items-center py-1">
