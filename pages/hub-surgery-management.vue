<template>
  <section>
    <AppBreadcrumbs v-if="!['hub-surgery-management-index', 'hub-surgery-management-invitations-spoke', 'hub-surgery-management-invitations-hub'].includes($route.name)" :links="links" /> 
