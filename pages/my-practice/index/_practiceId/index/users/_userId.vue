        ...
        <div class="rounded-lg shadow-lg p-4 md:p-8 mt-4">
          <div class="flex flex-col">
            <div class="body-info">
              ...
              <div class="text-sm sm:text-md mb-4 md:mb-8">
                {{ user.practice_detail.practice_role }}
              </div>
              <div class="font-bold text-md md:text-lg">
                Surgery
              </div>
              <div class="text-sm sm:text-md mb-4 md:mb-8">
                {{ user.practice_detail.practice.surgery.name }}
              </div>
              <div class="font-bold text-md md:text-lg">
                Email
              </div>
  ...
  export default {
    ...
    async asyncData ({ app, params }) {
      try {
        ...
        const user = await app.$axios.get(`/api/v1/locum/practice-users/${userId}`).then((response) => {
