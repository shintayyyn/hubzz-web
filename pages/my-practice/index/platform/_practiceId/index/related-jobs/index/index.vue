    ...
    <transition name="fade" mode="out-in">
      ...
      <div v-if="!initialLoading">
        <AppFilter :enableSearch="false">
          ...
          <template v-slot:filter>
            <template v-if="!isJobPart">
              ...
              <div class="w-24">
                <AppTime v-model="time_start" :name="'time_start'" :label="'Start Time'" nolabel border :wrapperClass="'px-1'" />
              </div>
              <div class="flex-1">
                <AppDate
              ...
              <div class="w-24">
                <AppTime v-model="time_end" :name="'time_end'" :label="'End Time'" nolabel border :wrapperClass="'px-1'" />
              </div>
              <div class="flex-1">
                <AppPostCode
            ...
            <template v-if="isJobPart">
              ...
              <div class="flex-1">
                <AppTime v-model="time_start" :name="'time_start'" :label="'Start Time'" :wrapperClass="'px-1'" border nolabel />
              </div>
              <div class="flex-1">
                <AppDate
                  v-model="calendar_date_end"
              ...
              <div class="flex-1">
                <AppTime v-model="time_end" :name="'time_end'" :label="'End Time'" :wrapperClass="'px-1'" border nolabel />
              </div>
              <div class="flex-1">
                <AppPostCode
                  v-model="near_post_code"
        ...
        <AppTable
          ...
          :orderBy="order_by"
          :loading="loading"
          :routerLink="`/my-practice/platform/${$route.params.practiceId}/related-jobs`"
        ...
        <transition name="fade" mode="out-in">
          <nuxt-link
            v-if="$route.name === 'my-practice-index-platform-practiceId-index-related-jobs-index-jobId'"
            class="shield"
            :to="{ path: `/my-practice/platform/${$route.params.practiceId}/related-jobs?status=${$route.query.jobStatus ? $route.query.jobStatus : 'Allocated'}`, query: {...$route.query}}"
          />
        </transition>
        <div>
          <nuxt-child
