<template>
  <section class="relative __jobs-section">
    ...
    <div
      class="shield"
      v-if="$route.name === 'my-practice-completed-practiceId-related-jobs-declined-jobId'"
    ></div>
    <nuxt-child />
  </section>
</template>
...
export default {
  ...
  methods: {
    ...
    show(id) {
      this.$router.push(
        `/my-practice/completed/${this.$route.params.practiceId}/related-jobs/declined/${id}`
      );
    }
  }
};
