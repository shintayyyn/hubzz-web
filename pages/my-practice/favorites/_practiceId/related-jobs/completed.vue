<template>
  <section class="relative __jobs-section">
    ...
    <div
      class="shield"
      v-if="$route.name === 'my-practice-favorites-practiceId-related-jobs-completed-jobId'"
    ></div>
    <nuxt-child />
  </section>
</template>
...
export default {
  ...
  methods: {
    ...
    show(id) {
      this.$router.push(
        `/my-practice/favorites/${this.$route.params.practiceId}/related-jobs/completed/${id}`
      );
    }
  }
};
