<template>
  <section class="relative __jobs-section">
    ...
    <div v-if="getLocumDeclinedJobs.length > 0" class="overflow-x-auto overflow-y-hidden p-2">
    ...
    <div
      class="shield"
      v-if="$route.name === 'my-practice-favorites-practiceId-related-jobs-declined-jobId'"
      @click="$router.go(-1)"
    ></div>
    <nuxt-child />
  </section>
