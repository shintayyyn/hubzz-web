  ...
  <div class="p-2">
      ...
      <a
        ...
        @click.prevent="
          downloadItem(
            ...
            compliance_document.file.filename
          )
        "
      >
        <svgicon
    ...
    <div class="flex flex-col">
      <div class="shadow-lg rounded-lg bg-gray-300 mt-4 max-w-5xl">
        <div
          v-if="compliance_document"
          class="flex flex-row flex-wrap justify-start p-4 md:p-8"
        >
          <div class="flex flex-col w-full lg:w-1/4 pr-4">
            ...
            <p class="mt-2 text-sm md:text-base">
              {{
                compliance_document.compliance_document
                  ? compliance_document.compliance_document.name
                  : null
              }}
            </p>
            <div
            ...
            <div v-if="compliance_document.type != 'Optional'">
              <p class="mt-5 font-bold text-lg">
                Status
              </p>

              <div
                class="mt-2 text-sm md:text-base px-3 py-1 rounded-full inline-block"
                :class="statusBadgeClass(compliance_document.status)"
              >
            ...
            <div v-if="compliance_document.status === 'Rejected'">
              ...
              <p class="mt-2 text-sm md:text-base">
                {{
                  compliance_document && compliance_document.note
              ...
              <button
                ...
                @click.stop.prevent="
                  uploadCompliance(
                    ...
                    compliance_document.compliance_document_type_name,
                    compliance_document.file,
                    compliance_document.has_reference,
                    compliance_document.reference,
                    compliance_document.country_id,
                    'optional'
                  )
                "
              >
          ...
          <div class="mt-5 lg:mt-0 w-full lg:w-3/4">
            ...
            <embed
              ...
              :src="
                ...
                ].includes(compliance_document.file.subtype)
