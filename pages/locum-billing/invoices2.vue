  ...
  <section class="relative">
    <div class="flex flex-row justify-start overflow-x-auto border-b border-gray-500 mb-4 pt-1">
      ...
      <nuxt-link
        ...
        class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer whitespace-no-wrap"
        :class=" $route.name.includes('locum-billing-invoices') && ($route.query.status && $route.query.status.toLowerCase() === 'pension-form-a') ? 'border-b-4 border-gray-500' : 'text-gray-600'"
      >
        NHS Pensions Form A
      </nuxt-link>
