<template>
  <section class="__jobs-section">
    ...
    <div
      class="shield"
      v-if="$route.name === 'my-banks-withdrawn-userId-related-jobs-declined-jobId'"
    ></div>
    <nuxt-child />
  </section>
</template>
...
export default {
  ...
  methods: {
    ...
    show(id) {
      this.$router.push(`/my-banks/withdrawn/${this.$route.params.userId}/related-jobs/declined/${id}`)
    },
  }
}
</script>
