<template>
  <section class="__jobs-section">
    ...
    <div
      class="shield"
      v-if="$route.name === 'my-banks-rejected-userId-related-jobs-unsuccessful-jobId'"
    ></div>
    <nuxt-child />
  </section>
</template>
...
export default {
  ...
  methods: {
    ...
    show(id) {
      this.$router.push(`/my-banks/rejected/${this.$route.params.userId}/related-jobs/unsuccessful/${id}`)
    },
  }
}
</script>
