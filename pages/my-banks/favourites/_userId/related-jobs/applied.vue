<template>
  <section class="__jobs-section">
    ...
    <div
      class="shield"
      v-if="$route.name === 'my-banks-favourites-userId-related-jobs-applied-jobId'"
    ></div>
    <nuxt-child />
  </section>
</template>
...
export default {
  ...
  methods: {
    ...
    show(id) {
      this.$router.push(`/my-banks/favourites/${this.$route.params.userId}/related-jobs/applied/${id}`)
    },
  }
}
</script>
