			...
			<div class="w-full pr-0 lg:pr-2 lg:w-1/2">
				<div class="rounded-lg shadow-lg p-4">
					<div class="flex flex-col">
						...
						<div
							class="text-sm mb-8"
						>{{ user.locum_detail.headline && user.locum_detail.headline ? user.locum_detail.headline : '(none)' }}</div>
						<div class="font-bold text-sm sm:text-md">Biography</div>
						<div
							class="text-sm mb-8"
						>{{ user.locum_detail.headline && user.locum_detail.short_biography ? user.locum_detail.short_biography : '(none)' }}</div>
