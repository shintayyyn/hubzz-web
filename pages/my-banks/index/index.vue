  ...
  <section>
    ...
    >
      <nuxt-link
        ...
        :to="{
          path: '/my-banks',
          query: { ...$route.query, surgeries_bank: undefined }
        }"
        class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer"
        :class="!surgeriesBank ? 'border-b-4 border-gray-500' : 'text-gray-600'"
      >
        Banks
      </nuxt-link>
      ...
      <nuxt-link
        ...
        :to="{
          path: '/my-banks',
          query: { ...$route.query, surgeries_bank: 'true' }
        }"
        class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer"
        :class="surgeriesBank ? 'border-b-4 border-gray-500' : 'text-gray-600'"
      >
    ...
    >
      <nuxt-link
        ...
        :to="{
          path: '/my-banks',
          query: { ...$route.query, profession_category_name: undefined }
        }"
        class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer"
        :class="
      ...
      <nuxt-link
        ...
        :to="{
          path: '/my-banks',
          query: { ...$route.query, profession_category_name: 'Others' }
        }"
        class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer"
        :class="
    ...
    <transition name="fade" mode="out-in">
      <div v-if="toggleTable">
        <div class="flex flex-row flex-wrap justify-start">
          ...
          >
            <div
              class="h-full rounded-lg shadow-lg bg-gray-300 hover:bg-gray-400 p-4"
            >
              <nuxt-link
                :to="{
                  path: `/my-banks/${locum.id}`,
                  query: { ...$route.query }
                }"
              >
        ...
        <div
          v-if="locums.length > 0 && totalPages > 1"
        ...
        <transition name="fade" mode="out-in">
          <nuxt-link
            v-if="
              $route.name.includes('my-banks-index-locumId') &&
                !sendMessageModal
            "
        ...
        .get(`/api/v1/practice/locums/count`, {
          ...
          params: {
            ...
            profession_category_name:
              this.practiceLocumType === "All"
                ? ""
                : this.professionCategoryName,
