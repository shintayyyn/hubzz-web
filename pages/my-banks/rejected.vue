...
const tabs = [
  'my-banks-rejected-userId', 'my-banks-rejected-userId-profile', 'my-banks-rejected-userId-related-jobs',
  'my-banks-rejected-userId-related-jobs-available', 'my-banks-rejected-userId-related-jobs-applied',
  'my-banks-rejected-userId-related-jobs-current', 'my-banks-rejected-userId-related-jobs-completed',
  'my-banks-rejected-userId-related-jobs-unsuccessful', 'my-banks-rejected-userId-related-jobs-cancelled',
...
export default {
  ...
  methods: {
    ...
    getLocums(page) {
      ...
      let defaultParams = { offset: this.offset, limit: this.perPage, practice_locum_type: 'Rejected' }
    ...
    show(id) {
      this.$router.push(`/my-banks/rejected/${id}`)
    },
    pagechanged(e) {
      this.current_page = e
      this.getLocums(this.current_page)
