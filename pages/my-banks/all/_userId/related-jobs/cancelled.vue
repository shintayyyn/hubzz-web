<template>
  <section class="__jobs-section">
    ...
    <div class="shield" v-if="$route.name === 'my-banks-all-userId-related-jobs-cancelled-jobId'"></div>
    <nuxt-child />
  </section>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    show(id) {
      this.$router.push(`/my-banks/all/${this.$route.params.userId}/related-jobs/cancelled/${id}`)
    },
  }
}
</script>
