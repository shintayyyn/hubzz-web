<template>
	<section class="dashboard-section">
		...
		<div v-if="!userIsAuthorized && $auth.user.domain === 'Practice'">
			...
			>Hubzz is in the process of verifying your registration. You will receive a notification when this has been completed, with full access to the platform.</div>
			<!-- <div
				class="text-sm sm:text-base font-bold"
		...
		<transition name="fade" mode="out-in">
			<nuxt-link
				class="shield"
				v-if="['dashboard-id','dashboard-create'].includes($route.name) || expense_modal"
				:to="'/dashboard'"
			></nuxt-link>
		</transition>
