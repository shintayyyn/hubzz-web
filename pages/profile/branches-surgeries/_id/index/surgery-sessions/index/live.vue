<template>
  <section class="relative">
    ...
    >This spoke has no live jobs</div>
    ...
    <div class="w-full mt-4" v-if="getPracticeAvailableJobs.length > 0 && totalPages > 1">
      <AppPagination
        :total="total"
    ...
    <div class="shield" v-if="$route.name === 'sessions-live-sessionId'"></div>
    <nuxt-child />
  </section>
</template>
<script>
