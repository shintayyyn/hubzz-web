<template>
  <div class="">
    <div class="flex flex-col items-start">
      ...
      <div
        class="w-full flex justify-start overflow-x-auto mb-3 border-b border-sunglow"
      >
        <nuxt-link
          :to="`/profile/users/${$route.params.id}`"
          class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer whitespace-no-wrap"
          :class="
            ['profile-users-id-general', 'profile-users-id'].includes(
              $route.name
            )
        ...
        >
          <nuxt-link
            ...
            class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer whitespace-no-wrap"
            :class="
              $route.name === 'profile-users-id-change-password'
                ? 'border-b-4 border-sunglow'
                : 'text-gray-600'
            "
          >
