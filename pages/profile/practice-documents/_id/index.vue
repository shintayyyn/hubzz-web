    ...
    <div class="flex items-center">
      ...
      >
        <a
          ...
          @click.prevent="
            downloadItem(
              practice_document.file.url,
              practice_document.file.filename
            )
          "
        >
          <svgicon
      ...
      <div class="flex flex-row flex-wrap justify-start p-4 md:p-8">
        <div class="flex flex-col w-full lg:w-1/4">
          ...
          <p class="mt-2 text-base">
            {{
              practice_document.practice_document_type
                ? practice_document.practice_document_type.name
                : null
            }}
          </p>
          ...
          <p class="mt-2 text-base">
            {{
              practice_document.last_uploaded_at_in_gb_formatted
                ? practice_document.last_uploaded_at_in_gb_formatted
                : null
            }}
          </p>
        ...
        <div class="w-full mt-5 lg:mt-0 lg:w-3/4">
          <embed
            ...
            :class="
              practice_document.file.type == 'image'
                ? 'image'
                : 'document h-full '
            "
            :src="
              ...
              ].includes(practice_document.file.subtype)
                ? convertDoc(practice_document.file.url)
                : practice_document.file.url
            "
          >
        </div>
