    ...
    <div class="p-8 w-full">
      ...
      <div class="flex overflow-x-auto">
        <nuxt-link
          ...
          :class="
            $route.name === 'profile-practice-spokes-id' ? 'border rounded-lg border-yellow-500 bg-yellow-500' : 'text-gray-600'
          "
          >Profile</nuxt-link
        >
        <nuxt-link
          ...
          class="md:mr-5 p-3 text-sm font-bold cursor-pointer whitespace-no-wrap"
          :class="
            $route.name.includes('profile-practice-spokes-id-surgery-sessions') ||
