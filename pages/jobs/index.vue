<template>
  <section class="relative">
    <div v-if="$route.query.status && ['available', 'public', 'bank'].includes($route.query.status.toLowerCase())"
    ...
    <transition name="fade" mode="out-in">
      ...
      <div v-if="!initialLoading">
        <AppButton :label="'Filter'" :in-style="'padding:5px 14px;margin-bottom:5px;font-size:14px;'"
                   @click="filterModal = !filterModal"
        />

        <AppButton v-if="showRefresh" :label="'Refresh'"
                   :in-style="'padding:5px 14px;margin-bottom:5px;font-size:14px;'" @click="refreshJobs"
        />
        ...
        >
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppInput v-model="job_number_includes" class="px-1" :type="'text'" :name="'job_number_includes'"
                      :label="'Job number'"
            />
          </div>
          <div v-if="!$route.query.status || ($route.query.status && $route.query.status.toLowerCase() !== 'private')"
          ...
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppInput v-model="title_includes" class="px-1" :type="'text'" :name="'title_includes'"
                      :label="'Job Title'"
            />
          </div>
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppInput v-model="shift_id" class="px-1" :type="'select'" :name="'shift_id'" :label="'Shift'"
                      :items="shifts"
            />
          </div>
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppInput v-model="rate" class="px-1" :type="'number'" :name="'rate'" :label="'Rate'"
                      :in-style="'padding-top:0.5rem;padding-bottom:0.5rem;text-align:right'"
            />
          </div>
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppInput v-model="rate_type_id" class="px-1" :type="'select'" :name="'rate_type_id'" :label="'per'"
                      :items="rates"
            />
          </div>
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
          ...
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppPostCode v-model="near_post_code" class="px-1" :name="'near_post_code'" :label="'Post code'" />
          </div>
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppInput v-model="miles" class="px-1" :type="'number'" :name="'miles'" :label="'Miles'" />
          </div>
          <div class="md:px-1 flex w-full">
            <AppButton :label="'Clear'" :in-style="'padding:5px 14px;margin-bottom:5px'" @click="clearFilters" />
            <AppButton class="mx-2" :label="'Search'" :in-style="'padding:5px 14px;margin-bottom:5px'"
                       @click="filterJob"
            />
            <AppButton class="mx-2 md:hidden" :label="'Close'" :in-style="'padding:5px 14px;margin-bottom:5px'"
        ...
        >
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppInput v-model="job_part_number_includes" class="px-1" :type="'text'" :name="'job_part_number_includes'"
          ...
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppInput v-model="job_title_includes" class="px-1" :type="'text'" :name="'job_title_includes'"
                      :label="'Job Title'"
            />
          </div>
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppInput v-model="job_shift_id" class="px-1" :type="'select'" :name="'job_shift_id'" :label="'Shift'"
                      :items="shifts"
            />
          </div>

          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppInput v-model="job_rate" class="px-1" :type="'number'" :name="'job_rate'" :label="'Rate'"
                      :in-style="'padding-top:0.5rem;padding-bottom:0.5rem;text-align:right'"
            />
          </div>
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppInput v-model="job_rate_type_id" class="px-1" :type="'select'" :name="'job_rate_type_id'" :label="'per'"
                      :items="rates"
            />
          </div>
          ...
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppInput v-model="invoice_status" class="px-1" :type="'select'" :name="'invoice_status'"
        ...
        <AppTable v-if="jobs.length > 0" :total="total" :items="jobs" :current-page="current_page" :per-page="limit"
                  :columns="columns" :order-by="order_by" :loading="loading" :router-link="'/jobs'" @pagechanged="pagechanged"
        ...
        <transition name="fade" mode="out-in">
          <nuxt-link v-if="$route.name === 'jobs-index-id'" class="shield"
