          ...
          <div v-for="item in mandatoryComplianceDocuments" :key="item.compliance_document_id">
            ...
            >
              ...
              >
                ...
                <template v-else>{{ item.compliance_document_name }}</template>
              </div>
              <template v-if="item.compliance_document_type_name !== 'Safeguarding'">
                  ...
                  <div v-if="item.file" class="flex flex-row flex-no-wrap items-center">
                    ...
                    <div class="mx-2">
                      ...
                      >
                        ...
                        >{{ item.file.filename | StringMaxLength(10) }}</span>
                      </a>
                    </div>
                  </div>
                  <div
                ...
                <div v-else class="item w-1/6 py-2" />
                <div
                ...
                <div v-else class="item w-1/6 py-2" />
                <div
                  v-if="item && item.expired_at"
                  class="item w-1/6"
                >{{ item.expired_at | localDate }}</div>
                <div v-else class="item w-1/6 py-2" />
              </template>
            ...
            <div v-if="item.compliance_document_type_name === 'Safeguarding'">
              ...
              >
                ...
                >
                  <div
                    class="item w-1/6 pr-2"
                  >{{ childItem.compliance_document_name | StringMaxLength(55) }}</div>
      ...
      <div class="mt-4 overflow-x-auto">
        ...
        <div class="table">
          ...
          <div v-for="item in optionalComplianceDocuments" :key="item.compliance_document_id">
            ...
            >
              <div
                :class="item.compliance_document_type_name !== 'Safeguarding' ? 'item w-1/3' : ''"
              >
                <template
                  v-if="item.compliance_document_type_name === 'Safeguarding'"
                >{{ item.compliance_document_name }}</template>
                <template v-else>{{ item.compliance_document_name | StringMaxLength(55) }}</template>
              </div>
