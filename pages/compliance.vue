<template>
  <section class="compliance-section">
    ...
    <div class="overflow-x-auto">
      <div v-if="referenceComplianceDocuments.length > 0" class="mt-10">
            ...
            >
              ...
              >
                <template v-if="item.compliance_document_type_name !== 'Safeguarding'">
                  ...
                  <span v-if="item.compliance_document_type_name === 'Passport' && item.country_name">{{ `${item.country_name} VISA? ${hasVisa ? 'Yes' : 'No'}` }}</span>
                </template>
              ...
              <template v-if="item.compliance_document_type_name !== 'Safeguarding'">
                <div v-if="(item.file || item.reference)" class="item w-1/6">
                  ...
                  <div v-if="item.reference && item.reference !== 'null'" class="flex flex-row flex-no-wrap items-center">
                    {{ item.reference }}
                  </div>
                </div>
              ...
              >
                ...
                >
                  ...
                  <div v-if="(childItem.file || childItem.reference)" class="item w-1/6">
                    ...
                    <div v-if="childItem.reference && childItem.reference !== 'null'" class="flex flex-row flex-no-wrap items-center">
                      {{ childItem.reference }}
                    </div>
                  </div>
            ...
            <div v-if="item.compliance_document_type_name === 'Safeguarding'">
              ...
              >
                ...
                >
                  ...
                  <div class="md:w-1/6 flex flex-row flex-no-wrap justify-end items-center" style="position:sticky;right:0">
                    <div
                      class="bg-yellow-500 px-4 py-2 rounded cursor-pointer"
          ...
          <table>
            ...
            <tbody>
              <template v-for="(item, index) in mandatory_trainings">
                <tr v-if="activeLoading.includes(item.mandatory_training.id)" :key="item.id" class="text-left bg-gray-200">
          ...
          <table>
            ...
            <tbody>
              <template v-for="(item, index) in other_mandatory_trainings">
                <tr v-if="activeLoading.includes(item.locum_other_mandatory_training_id)" :key="item.id" class="text-left bg-gray-200">
                  <td colspan="4" class="loader-message md:text-center text-gray-800">
                    Uploading
                  </td>
                </tr>
