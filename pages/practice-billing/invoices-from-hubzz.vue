<template>
  <div>
    <div class="flex flex-row justify-start overflow-x-auto border-b border-gray-300">
      <nuxt-link
        :to="{ path: '/practice-billing/invoices-from-hubzz'}"
        class="md:mr-5 p-3 text-xs font-bold cursor-pointer whitespace-no-wrap"
        :class="$route.name === 'practice-billing-invoices-from-hubzz' ? 'border-b-2 border-gray-500' : 'text-gray-600'"
      >
        HUBZZ Invoices
      </nuxt-link>
