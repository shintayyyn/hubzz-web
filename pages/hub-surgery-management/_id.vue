<template>
  <div class="w-full">
    ...
    <div
      v-if="
        !$route.params.permJobId &&
          !$route.params.invoiceId &&
          !$route.params.locumId &&
          !$route.params.jobId &&
    ...
    >
      <nuxt-link
        v-if="
          relationshipIsActive == 'Active' &&
            authPermissions.includes('View Surgery Management')
        "
        :to="{ path: `/hub-surgery-management/${$route.params.id}` }"
        class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer whitespace-no-wrap"
        :class="
          $route.name === 'hub-surgery-management-id'
      ...
      <nuxt-link
        v-if="
          relationshipIsActive == 'Active' &&
            authPermissions.includes('View Surgery Sessions')
        "
        :to="{
        ...
        class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer whitespace-no-wrap"
        :class="
          $route.name === 'hub-surgery-management-id-surgery-sessions' ||
            $route.name.includes(
              'hub-surgery-management-id-surgery-sessions-index'
            )
            ? 'border-b-4 border-sunglow'
            : 'text-gray-600'
        "
      ...
      <nuxt-link
        v-if="
          relationshipIsActive == 'Active' &&
            authPermissions.includes('View Surgery Billings')
        "
        :to="{
        ...
        class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer whitespace-no-wrap"
        :class="
          $route.name === 'hub-surgery-management-id-surgery-billings' ||
            $route.name.includes('hub-surgery-management-id-surgery-billings')
            ? 'border-b-4 border-sunglow'
            : 'text-gray-600'
        "
      >
      ...
      <nuxt-link
        v-if="
          relationshipIsActive == 'Active' &&
            authPermissions.includes('View Surgery Banks')
        "
        :to="{
          path: `/hub-surgery-management/${$route.params.id}/surgery-banks`,
          query: { ...$route.query }
        }"
        class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer whitespace-no-wrap"
        :class="
          $route.name === 'hub-surgery-management-id-surgery-banks'
            ? 'border-b-4 border-sunglow'
            : 'text-gray-600'
        "
      >
      ...
      <nuxt-link
        v-if="
          relationshipIsActive == 'Active' &&
            authPermissions.includes('View Surgery Permanent Jobs')
        "
        :to="{
          path: `/hub-surgery-management/${$route.params.id}/surgery-permanent-jobs`
        }"
        class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer whitespace-no-wrap"
        :class="
          $route.name ===
            'hub-surgery-management-id-surgery-permanent-jobs-index'
            ? 'border-b-4 border-sunglow'
            : 'text-gray-600'
        "
      >
        ...
        v-if="
          relationshipIsActive == 'Active' &&
            authPermissions.includes(
              'Request for Termination Surgery Management'
            )
        "
        :to="{
          path: `/hub-surgery-management/${$route.params.id}/request-for-termination`,
          query: { ...$route.query }
        }"
        class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer whitespace-no-wrap"
        :class="
          $route.name === 'hub-surgery-management-id-request-for-termination'
            ? 'border-b-4 border-sunglow'
            : 'text-gray-600'
        "
      >
...
export default {
  ...
  created() {
    this.surgeryManagementPermissions = this.authPermissions.filter(item =>
      item.includes("View Surgery")
    );
    let toRedirect = "";
    if (
      this.surgeryManagementPermissions.find(
        item => item === "View Surgery Management"
      ) === undefined
    ) {
      ...
      this.$router.push(
        `/hub-surgery-management/${this.$route.params.id}/${toRedirect}`
      );
    }
  },
