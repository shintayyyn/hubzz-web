<template>
  <section class="relative">
    <div
      class="flex flex-row justify-start overflow-x-auto border-b border-gray-500"
    >
      <nuxt-link
        :to="{
          path: `/hub-surgery-management/${$route.params.id}/surgery-billings/invoices-from-locums?status=to-be-invoiced`
        }"
      ...
      <nuxt-link
        :to="{
          path: `/hub-surgery-management/${$route.params.id}/surgery-billings/invoices-from-locums?status=disputed`
        }"
        class="md:mr-5 p-3 text-xs font-bold cursor-pointer whitespace-no-wrap"
        :class="
          $route.name.includes(
      ...
      <nuxt-link
        :to="{
          path: `/hub-surgery-management/${$route.params.id}/surgery-billings/invoices-from-locums?status=issued`
        }"
        class="md:mr-5 p-3 text-xs font-bold cursor-pointer whitespace-no-wrap"
        :class="
          $route.name.includes(
      ...
      <nuxt-link
        :to="{
          path: `/hub-surgery-management/${$route.params.id}/surgery-billings/invoices-from-locums?status=approved`
        }"
        class="md:mr-5 p-3 text-xs font-bold cursor-pointer whitespace-no-wrap"
        :class="
          $route.name.includes(
      ...
      <!-- <nuxt-link
        ...
        :class="
          $route.name.includes(
            ...
            $route.query.status &&
            $route.query.status.toLowerCase() === 'solo-form'
            ? 'border-b-4 border-gray-500'
            : 'text-gray-600'
        "
      >
      ...
      <nuxt-link
        :to="{
          path: `/hub-surgery-management/${$route.params.id}/surgery-billings/invoices-from-locums?status=pension-form-a`
        }"
        class="md:mr-5 p-3 text-xs font-bold cursor-pointer whitespace-no-wrap"
        :class="
          $route.name.includes(
            ...
            $route.query.status &&
            $route.query.status.toLowerCase() === 'pension-form-a'
            ? 'border-b-4 border-gray-500'
            : 'text-gray-600'
        "
      >
    ...
    <transition name="fade" mode="out-in">
      ...
      <div v-if="!initialLoading" class="my-2">
          ...
          <template v-slot:actions="slotProps">
            <div class="flex flex-col bg-white border rounded border-gray-500">
              <div
                ...
                @click="
                  $router.push({
                    path: `/hub-surgery-management/${$route.params.id}/surgery-billings/invoices-from-locums/${slotProps.item.locum_invoice_id}/edit`,
                    query: { ...$route.query }
                  })
                "
              >
              ...
              <div
                ...
                @click="
                  $router.push({
                    path: `/hub-surgery-management/${$route.params.id}/surgery-billings/invoices-from-locums/${slotProps.item.locum_invoice_id}`,
                    query: { ...$route.query }
                  })
                "
              >
          ...
          <nuxt-link
            v-if="
              [
                ...
                'hub-surgery-management-id-surgery-billings-invoices-from-locums-invoiceId-edit'
              ].includes($route.name) || payment_modal
            "
            :to="{
        ...
        <nuxt-child
          :child-practice-id="childPracticeId"
  ...
  computed: {
    columns() {
      ...
      if (
        ...
        queryStatus === "pension-form-a" ||
        queryStatus === "solo-form"
      ) {
        columns.push({
          name: "Approved At",
      ...
      if (queryStatus !== "to-be-invoiced") {
        columns.push({
          name: "Actions",
          dataIndex: "actions",
          class: ["approved", "solo-form"].includes(queryStatus)
            ? "dropdown"
            : "text-center",
          initialDropdown: ["approved"].includes(queryStatus)
            ? "View"
            : "View Solo Form",
          width:
            queryStatus === "solo-form"
              ? 165
              : ["approved"].includes(queryStatus)
                ? 115
                : 80
        });
      }
