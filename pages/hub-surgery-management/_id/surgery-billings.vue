<template>
  <section class="billing-section">
    <div class="flex flex-row justify-start overflow-x-auto py-3">
      <nuxt-link
        v-if="practiceSurgery.allow_surgery_bill_locum === true || practiceSurgery.allow_surgery_bill_locum === 1"
      ...
      <nuxt-link
        v-if="practiceSurgery.allow_surgery_bill_hubzz === true || practiceSurgery.allow_surgery_bill_hubzz === 1"
