  ...
  <section class="billing-section">
    <div class="flex flex-row justify-start overflow-x-auto border-b-2 border-gray-300">
      <nuxt-link
        ...
        :class="$route.name.includes('hub-surgery-management-id-surgery-billings-invoices-from-locums')? 'border-b-2 border-gray-500' : 'text-gray-600'"
      >
      ...
      <nuxt-link
        ...
        class="md:mr-5 p-3 text-sm font-bold cursor-pointer whitespace-no-wrap"
        :class="$route.name === 'hub-surgery-management-id-surgery-billings-invoices-from-hubzz' ? 'border-b-2 border-gray-500' : 'text-gray-600'"
      >
        Invoices from hubzz
      </nuxt-link>
    </div>
