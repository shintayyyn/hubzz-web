  ...
  <div class="px-2 w-full">
    ...
    <div class="flex flex-wrap items-center my-2">
      ...
      <div class="flex items-center">
        ...
        >
          {{ practice_surgery.child_practice_type }}
        </div>
        <div
          class="justify-center text-black text-sm font-semibold py-2 p-3 mr-2 rounded-lg"
    ...
    <div
      class="flex flex-col md:flex-row justify-start items-start w-full mt-2"
    >
      <div
      ...
      >
            ...
            :class="
              `${
                editPayForSurgery == false
                  ? 'text-black bg-sunglow hover:bg-sunglow-dark'
        ...
        <template v-if="editPayForSurgery === false">
          <div class="flex items-center py-1">
            ...
            <div class="font-semibold">
              Is this Spoke allowed to Create Jobs?
            </div>
          </div>
          <div
          ...
          <div class="flex items-center py-1">
            ...
            <p class="font-semibold">
              Is this Spoke allowed to create permanent jobs?
            </p>
          </div>
          ...
          <div class="flex items-center py-1">
            ...
            <p class="font-semibold">
              Is this Spoke allowed to bill of Locums?
            </p>
          </div>
          ...
          <div class="flex items-center py-1">
            ...
            <p class="font-semibold">
              Is this Spoke's Banks shared to other Spokes?
            </p>
          </div>
          <div class="flex items-center py-1">
            <span class="mr-3 md:mx-2">
            ...
            <p class="font-semibold">
              Is My Banks shared to this Surgery?
            </p>
          </div>
        </template>
        <!--------------EDIT PERMISSIONS------------------>
...
export default {
  ...
  data() {
    return {
      editPayForSurgery: false,
      form: {
        allow_surgery_create_sessions: null,
        max_hourly_rate_limit: null,
        max_halfday_rate_limit: null,
        max_wholeday_rate_limit: null,
        max_ooh_rate_limit: null,
        max_excess_hours: null,
        allow_surgery_create_permanent_jobs: null,
        allow_surgery_bill_locum: null,
        allow_surgery_bill_hubzz: null,
        share_banks_to_other_surgeries: null,
        share_my_banks: null
      },
      formError: [],
      surgeryCreateSessions: null
    };
  },
  ...
  methods: {
    getSurgery() {
      this.$axios
        .get(
          `/api/v1/practice/me/practice-surgeries/${this.$route.params.invitationId}`
        )
        .then(res => {
