    ...
    <div>
      ...
      >
        <div class="flex flex-col md:flex-row g-full items-end">
          ...
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppInput
              v-model="rate_range_includes"
              class="px-1"
              :type="'text'"
              :name="'rate_range_includes'"
              :label="'Rate £'"
          ...
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppInput
              v-model="rate_type_id_includes"
              class="px-1"
              :type="'select'"
              :name="'rate_type_id_includes'"
              :label="'per'"
              :items="rates"
            />
          </div>
...
export default {
  ...
  computed: {
    ...
    getRequestQueryFilters () {
      return {
        ...
        rate_range_includes: this.rate_range_includes,
        rate_type_id_includes: this.rate_type_id_includes,
  ...
  methods: {
    ...
    clearFilters () {
      ...
      this.shift_id = ""
      this.job_shift_id = ""
      this.rate_range_includes = ""
      this.rate_type_id_includes = ""
      this.near_post_code = ""
      this.miles = ""
