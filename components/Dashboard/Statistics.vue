  ...
  export default {
    ...
    methods: {
      ...
      setPracticeListeners () {
        ...
        this.$socket.on('Practice Notification Job Current', this.getPracticeStats)
      ...
      removePracticeListeners () {
        ...
        this.$socket.removeListener('Practice Notification Job Current', this.getPracticeStats)
