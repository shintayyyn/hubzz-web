<template>
  <div class="border-solid rounded-lg shadow-md p-5 mb-5">
    <div class="flex flex-row">
      <div class="text-xs xl:text-base px-1 w-1/2 sm:w-1/3">{{item.name}}</div>
      <div
        class="text-xs xl:text-base px-1 hidden sm:w-1/3 sm:block"
      >{{form.uploaded_date | localDate}}</div>
      <div class="text-xs xl:text-base px-1 w-1/2 sm:w-1/3">
