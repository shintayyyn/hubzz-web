    ...
    <div class="relative p-4 md:p-8">
      ...
      >
        <div class="mx-4 mt-4">
          ...
          <div v-if="uploadedFile" class="text-xs flex justify-between">
      ...
      <div class="flex flex-col md:flex-row">
        <div class="w-full md:w-3/5 lg:w-2/3 pr-2">
          <div class="bg-white rounded-lg shadow-lg p-4">
            ...
            <p class="pl-2 pb-3">
              {{ permanent_job ? permanent_job.practice.name : null }}
            </p>
            <p class="font-bold">
              Description
            </p>
...
export default {
  ...
  computed: {
    jobApplicationPitchLength () {
      return this.job_application.job_application_pitch.replace(/(<([^>]+)>)/ig, '').length || 0
    },
  },
