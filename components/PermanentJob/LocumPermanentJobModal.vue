    ...
    <transition name="fade">
      <div v-if="permanent_job || permanent_job_application" :class="isPage ? 'px-2' : 'relative p-4 md:p-8'">
          ...
          <div class="mx-4 mt-4">
            <div class="w-full">
              ...
              <div class="mb-3 md:mb-6">
                ...
                <p
                  ...
                  :class="jobApplicationPitchLength > 2000 ? 'text-red-500' : 'text-gray-600'"
                >
                  <svgicon
            ...
            <div class="flex flex-col md:flex-row justify-between items-center w-full">
              <AppButton
                ...
                :disabled="(!canApply || jobApplicationPitchLength > 2000) || (!job_application.job_application_pitch && !job_application.file)"
                @click="apply()"
              />
              <label
        ...
        >
          ...
          <span
            v-if="permanent_job_application.application_status === 'For Interview'"
          >You have been invited for interview on {{ permanent_job_application.invitation_schedule_formatted }} GMT</span>
          <span
            v-if="permanent_job_application.application_status === 'Accepted'"
          >Your interview will be on {{ permanent_job_application.invitation_schedule_formatted }} GMT</span>
          <div v-if="permanent_job_application.application_status === 'For Interview'" class="flex">
            <div class="pb-2 mr-4">
              <input
                id="approveInterview"
          ...
          <div class="w-full md:w-3/5 lg:w-2/3 pr-2">
            ...
            <div class="bg-white rounded-lg border p-4 flex flex-col lg:flex-row">
              <div class="w-full lg:w-1/2">
                ...
                <p v-if="!permanent_job.description && !permanent_job.description_file" class="mb-3 ml-2">
                  (none)
                </p>
