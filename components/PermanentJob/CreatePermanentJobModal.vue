<template>
  <section ref="modalContainer" :class="isPage ? 'w-full' : 'modal-container'">
    <AppBreadcrumbs v-if="false" :links="links" />
    <div :class="isPage ? 'px-2' : 'p-4 md:p-8'">
      <svgicon
        ...
        @click="$router.go(-1)"
      />
      <div class="flex justify-start font-bold text-sm sm:text-xl mt-4">
        Create a Permanent Job
      </div>
      <div class="flex flex-col md:flex-row pb-4">
        <div class="md:w-1/2 px-2">
          <h4 class="font-bold pt-4">
            Practice
          </h4>
        ...
        <div class="md:w-1/2 px-2">
          ...
          <div class="bg-white rounded-lg  border p-4">
            ...
            <div v-if="!form.description_file" class="mb-0 md:mb-0">
