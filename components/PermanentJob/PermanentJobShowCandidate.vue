      ...
      <div class="flex flex-row flex-wrap justify-between mt-4">
        ...
        <div class="w-full pl-0 lg:pl-2 mt-8 lg:mt-0 lg:w-1/2">
          <div class="rounded-lg shadow-lg p-4 md:p-8 mb-4">
            ...
            <div>
              <no-ssr>
                <quill-editor class="border-none" :options="options" :content="permanentJobApp && permanentJobApp.job_application_pitch ? 
                  permanentJobApp.job_application_pitch : 'N/A'" disabled
                />
              </no-ssr>
            </div>
            <div v-if="permanentJobApp && permanentJobApp.cover_email_file"
                 class="flex items-center cursor-pointer hover:underline"
            >
              <span>
                <svgicon name="cloud-download" height="24" width="24" />
              </span>
              <a class="px-2 text-sm leading-tight" :href="permanentJobApp.cover_email_file.url"
                 :download="permanentJobApp.cover_email_file.filename" target="_blank"
          ...
          <div class="rounded-lg shadow-lg p-4 md:p-8 mb-4">
            ...
            <div class="flex flex-col mb-4 md:mb-8">
              ...
              >
                ...
                <a class="px-2 text-sm leading-tight" :href="item.file.url" :download="item.file.filename"
                   target="_blank"
