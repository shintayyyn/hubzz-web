      ...
      <div class="w-full flex flex-col bg-white p-4 rounded-lg shadow-lg">
        <div class="flex justify-between items-center pb-2">
          ...
          <div class="flex items-center">
            ...
            />
            <div v-if="!conversation_id && !profileOption" class="font-bold text-lg px-2 cursor-pointer hover:text-yellow-500" @click="$emit('close')">
              x
            </div>
          </div>
        </div>
        ...
        <div class="relative">
          <MessagesCenterPanelForm :wrapperClass="'flex-col custom'" :inClass="'min-height'" :user="user" />
          ...
          <transition name="drop-down">
            ...
            >
              ...
              <li
                v-if="profileOption"
                class="hover:bg-yellow-500 cursor-pointer px-3 py-1"
                @click="$emit('showProfile'), $emit('close')"
              >
                Profile
              </li>
              <li
