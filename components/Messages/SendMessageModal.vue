            ...
            <div class="message-modal flex flex-col bg-white p-4 rounded-lg shadow-lg md:w-2/3 lg:w-1/2 xl:w-1/3">
                <div class="flex justify-between items-center pb-2">
                    ...
                    <div class="flex items-center">
                        ...
                        <svgicon @click="showDropDown = !showDropDown" name="menu" height="24" width="24" class="cursor-pointer fill-current p-1"/>
                    </div>
                </div>
                <div class="relative">
                    ...
                    <transition name="drop-down">
                        <ul v-if="showDropDown" class="absolute right-0 top-0 bg-white border-b border-l border-r text-sm">
                            <li class="hover:bg-yellow-500 cursor-pointer px-3 py-1" @click="openConversation" v-if="conversation_id">
                                Conversation
                            </li>
                            <li class="hover:bg-yellow-500 cursor-pointer px-3 py-1" @click="$emit('showProfile'), showDropDown = false">
                                Profile
                            </li>
