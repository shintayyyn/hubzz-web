	...
	<section>
		...
		<div class="p-4 md:p-8 max-w-5xl">
			...
			<template v-if="!input_details">
				...
				<div class="rounded-lg shadow-lg overflow-auto mt-5" v-if="showResult && surgeries.length > 0">
					<div
			...
			<template v-if="input_details">
				<div class="mt-2 flex flex-col items-center justify-center xl:mx-4 w-full" ref="container">
					...
					<div class="flex justify-center mt-4">
						<AppButton :label="'<<'" @click="input_details = false" />
						<div class="mx-2"></div>
