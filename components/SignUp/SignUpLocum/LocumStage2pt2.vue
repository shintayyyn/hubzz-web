        ...
        <form class="relative w-full">
          ...
          >
            ...
            >
              ...
              <p v-if="item.file" class="text-xs">
                {{ item.file.name }}
              </p>
              <p
              ...
              >
                ...
                >
                  {{ formError.find(err => err.field === item.compliance_document_name.replace(/ /g, "_").toLowerCase()).message }}
                </p>
              </template>
            </div>
      ...
      <div v-if="complianceModal" class="flex justify-center upload-modal">
        <div class="relative border-solid rounded-lg bg-white p-4 shadow-lg w-4/5 md:w-2/5 xl:w-1/4">
          <div class="flex flex-col justify-center">
            <div class="flex justify-end font-bold cursor-pointer" @click="complianceModal = false">
              X
            </div>
            ...
            <transition name="drop-down">
              ...
              >
                {{ modalError.find(item => item.field === 'file').message.charAt(0).toUpperCase() + modalError.find(item => item.field === 'file').message.slice(1).replace(/_/g, " ") }}
              </div>
            </transition>
            <AppButton
              class="mt-8"
