<template>
  <div class="p-8 max-w-2xl">
    ...
    <div class="flex flex-row justify-start mt-8">
      ...
      <div class="mx-2 bg-green-light text-sm sm:text-sm p-2">COMPLETED</div>
    </div>
        ...
        <div class="rounded-lg shadow-lg p-8">
          <div class="flex flex-row flex-wrap justify-between">
            <div class="flex flex-col w-full md:w-1/2 p-0 md:pr-4">
              ...
              <div class="font-bold text-sm sm:text-md">Completed At</div>
              <div
                class="text-xs sm:text-sm mb-6"
                v-text="completed_at?$moment(completed_at).format('YYYY-MM-DD'):`(none)`"
              ></div>
              <div class="font-bold text-sm sm:text-md">Completed By</div>
              <div class="text-xs sm:text-sm mb-6" v-text="completed_by?completed_by:`(none)`"></div>
            </div>
