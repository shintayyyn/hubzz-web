	...
	<div class="bg-white rounded-lg shadow-lg p-4 md:p-8 mt-4">
		<div class="flex flex-row flex-wrap justify-between">
			<div class="flex flex-col w-full md:w-1/2 p-0 md:pr-4">
				...
				<template v-if="job_part.job.locum_status === 'Terminated'">
				...
				<template v-if="job_part.job.locum_status === 'Cancelled'">
...
export default {
	...
	computed: {
		session_requirements() {
			return this.job_part.job.platform_job.session_requirements.split(",");
		}
	},
	methods: {
		convertDoc(document) {
