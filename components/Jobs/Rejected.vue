...
export default {
  ...
  methods: {
    show() {
      this.$store.commit('SET_LOCUM_REJECTED_DETAIL_MODAL', true)
      this.$store.commit('SET_LOCUM_REJECTED_DETAIL_SHIELD', true)
      this.$store.commit('TOGGLED_RIGHT', 'locum-rejected-detail-modal')
