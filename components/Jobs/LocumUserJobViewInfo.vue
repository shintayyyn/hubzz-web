    ...
    <div class="flex flex-row flex-wrap">
      ...
      <div class="flex flex-col w-full md:w-1/3 p-0 md:pr-1">
        ...
        <div class="text-xs sm:text-sm mb-6 flex flex-row flex-wrap">
          ...
          <div v-for="item in job.compliance_documents" :key="item.id" class="rounded-lg bg-sunglow p-1 m-1">
            {{ item.name }}
          </div>
        </div>
      </div>
      
      <div class="flex flex-col w-full md:w-1/3 p-0 md:px-1">
        <div class="font-bold text-sm sm:text-md">
      ...
      <div class="flex flex-col w-full md:w-1/3 p-0 md:pl-1">
        ...
        <div class="text-xs sm:text-sm mb-6 flex flex-row flex-wrap">
          <div v-for="item in job.clinical_systems" :key="item.id" class="rounded-lg bg-sunglow p-1 m-1">
            {{ item.name }}
          </div>
        </div>
        ...
        <div class="text-xs sm:text-sm mb-6 flex flex-row flex-wrap">
          <div class="rounded-lg bg-sunglow p-1 m-1">
            English
          </div>

          <div v-for="item in job.spoken_languages" :key="item.id" class="rounded-lg bg-sunglow p-1 m-1">
            {{ item.name }}
          </div>
        </div>
        ...
        <div class="text-xs sm:text-sm mb-6 flex flex-row flex-wrap">
          ...
          <div v-for="item in job.mandatory_trainings" :key="item.id" class="rounded-lg bg-sunglow p-1 m-1">
            {{ item.name }}
          </div>
        </div>
        ...
        <div class="text-xs sm:text-sm mb-6 flex flex-row flex-wrap">
          ...
          <div v-for="item in job.other_mandatory_trainings" :key="item.id" class="rounded-lg bg-sunglow p-1 m-1">
            {{ item.name }}
          </div>
        </div>
