	...
	<div class="flex flex-col w-full">
		...
		<div class="relative bg-white rounded-lg shadow-lg p-4 md:p-8 mt-4">
            ...
            />
					...
					<div v-if="toSaveSched" class="shield" style="z-index: 70;" />
					<div
						v-if="toSaveSched"
					...
					<div v-if="editSchedule" class="shield" />
					<transition name="fade">
						<div
							v-if="editSchedule"
							class="message-modal schedule-wrapper fixed z-40 bg-white py-4 rounded flex flex-col"
						>
            ...
            :error="formError.find(item => item.field === 'unpaid_breaks_in_minutes')"
					...
					<template v-if="['false', false].includes(auto_assign_job)">
						...
						<div
							...
							class="flex flex-row flex-wrap items-end justify-between"
						>
