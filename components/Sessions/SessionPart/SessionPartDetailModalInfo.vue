  ...
  <div class="border rounded-lg p-4">
    ...
    <div class="w-full">
      ...
      <div class="mb-8">
        ...
        <p class="px-1 font-bold text-sm sm:text-md mb-2">
          Schedule
        </p>
        ...
        <div class="text-xs sm:text-sm overflow-y-auto flex flex-col items-center" style="max-height:205px;">
          <div style="position:sticky;top:0" class="flex justify-between w-full">
            <p
              ...
              :style="job_part && job_part.locum_invoiceable ? 'min-width:120px;max-width:120px' : 'min-width:180px;max-width:180px'"
            >
              DATE
            </p>
          ...
          <div v-for="(sched, index) in job_part.schedules" :key="index" class="flex justify-between w-full pb-2">
            <p
              :style="job_part && job_part.locum_invoiceable ? 'min-width:120px;max-width:120px' : 'min-width:180px;max-width:180px'"
            >
        ...
        <template v-if="job_part.use_variation_terms">
          <template v-if="job_part.variation_terms_file_id">
            ...
            <div class="text-xs sm:text-sm mb-6 flex flex-row flex-wrap">
              <div
                ...
                @click="viewFile = { file: job_part.variation_terms_file }"
              >
                View
              </div>
            </div>
          ...
          <template v-else-if="job_part.standard_terms_file_id">
            ...
            <div class="text-xs sm:text-sm mb-6 flex flex-row flex-wrap">
              <div
                class="mt-1 cursor-pointer bg-sunglow hover:bg-sunglow-dark rounded-lg px-4 py-1 transition-hover"
                @click="viewFile = { file: job_part.standard_terms_file }"
              >
                View
              </div>
            </div>
