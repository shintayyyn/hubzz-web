  ...
  <div class="relative bg-white rounded-lg shadow-lg p-4 md:p-8" :class="onChange && 'opacity-50'">
    <div class="flex flex-row flex-wrap justify-between">
      <div class="flex flex-col w-full md:w-1/2 p-0 md:pr-4">
        ...
        <div class="text-xs sm:text-lg font-bold mb-6">{{job_part.job_part_number}}</div>
        <div class="font-bold text-sm sm:text-md">Job description</div>
        <div class="text-xs sm:text-sm mb-6">{{job_part.job.description}}</div>
        ...
        <div class="text-xs sm:text-sm mb-4">{{job_part.job.total_hours}}</div>
        <div class="font-bold text-sm sm:text-md">Extra information</div>
        <div
          class="text-xs sm:text-sm mb-6"
        >{{job_part.job.platform_job.extra_information?job_part.job.platform_job.extra_information:`(none)`}}</div>
        <div class="font-bold text-sm sm:text-md">Report to</div>
        <div class="text-xs sm:text-sm mb-6">{{job_part.job.platform_job.report_to}}</div>
