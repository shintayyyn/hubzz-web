	...
	<section>
		<div class="p-4 md:p-8 max-w-3xl">
			...
			>
				...
				Waiting for locum's approval within {{ deadline.hours > 0 ? deadline.hours > 1 ? `${deadline.hours} hours` : `${deadline.hours} hour` : ''}} {{ deadline.hours ? 'and' : '' }} {{ deadline.minutes > 0 ? deadline.minutes > 1 ? `${deadline.minutes} minutes` : `${deadline.minutes} minute` : ''}},
