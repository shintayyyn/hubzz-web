...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      placeholder () {
        return this.value ? this.$moment(this.value, "YYYY-MM-DD").format("DD/MM/YYYY") : null
      },
    },
    ...
    methods: {
      ...
      getYearLists () {
        ...
        if (!this.isAfter) {
          ...
          for (let i = 0; i <= 10; i++) {
            this.yearLists.push(this.$moment(this.selectedYear, "YYYY").add(i, "years").format("YYYY"))
          }
        }

        this.yearLists.sort((a, b) => a - b)
      },
      ...
      isDisabled (date) {
        ...
        if (this.isAfter) {
          ...
          return this.$moment(date, "MM-DD-YYYY").isBefore(this.$moment(newDate, "MM-DD-YYYY"))
        }
