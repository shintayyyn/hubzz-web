                ...
                <transition name="fade">
                  ...
                  >
                    <div class="w-full">
                      ...
                      <div
                        v-for="(scheduleDetail, scheduleDetailIndex) in scheduleDetails.shifts"
                        :key="scheduleDetailIndex"
                        class="px-1 border-t bg-gray-100"
                      >
                        <p>Shift: {{ getName('shift', scheduleDetail.shift_id) }}</p>
                        <p>Start time: {{ scheduleDetail.time_start }}</p>
                        <p>End time: {{ scheduleDetail.time_end }}</p>
                        <p>Rate: {{ scheduleDetail.rate }}</p>
                        <p>Rate Type: {{ getName('rate_type', scheduleDetail.rate_type) }}</p>
                      </div>
                    </div>
                  </div>
                </transition>
