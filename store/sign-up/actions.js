export default {
    ...
    registeredPractice({ state, commit }) {
        ...
        this.$axios
            .$post(`/api/v1/register/practice?referral_code=${state.practice_account_details.referral_code ? state.practice_account_details.referral_code : this.$router.app._route.query.referral_code}`, form)
            .then(() => {
    ...
    registeredLocum({ state, commit }) {
        ...
        this.$axios
            .$post(`/api/v1/register/locum?referral_code=${state.credential_details.referral_code ? state.credential_details.referral_code : this.$router.app._route.query.referral_code}`, form)
            .then(() => {
